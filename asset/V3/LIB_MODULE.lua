...
Library.Sections.__index = Library.Sections
	...
	do
		function Library:NewPicker(name, default, defaultalpha, parent, count, flag, callback)
			...
			IconInline.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	...
	do
		...
		function Library:Window(Options)
			local Window = {
				...
				Name = Options.Name or "Crimson Is Good asf Niggas";
			...
			HolderInline.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			FadeThing.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
...
Library:Connection(game:GetService("UserInputService").InputChanged, function(Input)
    if Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
		...
		function Pages:Section(Properties)
			...
			SectionInline.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
