...
do
	Library = {
		Open = true;
		Accent = Color3.fromRGB(27, 208, 232);
		Pages = {};
		Sections = {};
		Flags = {};
		UnNamedFlags = 0;
	...
	do
		...
		function Library:New(Properties)
			...
			if UserInputService.TouchEnabled then
			    ...
			    button.Text = '<font color="#1bd0e8">Aura</font><font color="#FFFFFF">.lol</font>'			
		...
		function Library:Watermark(Properties)
			local Watermark = {
				Name = (Properties.Name or Properties.name or "Aura.lol | placeholder");
				AnimateText = nil;
			}
			--
			local Outline = Instance.new("Frame")
			...
			task.spawn(function()
				while task.wait() do
					for i = 1, #"Aura.lol" do
						Watermark.AnimateText = string.sub("Aura.lol", 1, i) .. "";
						Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
						task.wait(0.4);
					end;

					for i = #"Aura.lol" - 1, 1, -1 do
						Watermark.AnimateText = string.sub("Aura.lol", 1, i) .. "";
						Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
						task.wait(0.4);
					end;
