...
-- // was modified by xr10 for an project at 11/26/24

-- // Custom Fonts https://github.com/Iuarmor/LegitSilent/blob/main/asset/v3/Fonts/mc_font.ttf
do 
    writefile("mc_font.ttf", game:HttpGet("https://raw.githubusercontent.com/Iuarmor/LegitSilent/main/asset/v3/Fonts/mc_font.ttf"))
    ...
    local Data = {
        ...
        faces = {{
            ...
            weight = 400,
            style = "normal",
            assetId = getcustomasset("mc_font.ttf")
        }}
    }

    writefile("menu_font.font", game:GetService("HttpService"):JSONEncode(Data))
...
do
	...
	do
		function Library:NewPicker(default, defaultalpha, parent, count, flag, callback)
			...
			local RInput = Instance.new('TextBox', Window)
			local GInput = Instance.new('TextBox', Window)
			local BInput = Instance.new('TextBox', Window)
			...
			do -- Inserts
				...
				--
				table.insert(Library.Instances, RInput)
				table.insert(Library.Instances, GInput)
				table.insert(Library.Instances, BInput)
			...
			--
			RInput.Name = "RInput"
			RInput.Position = UDim2.new(0, 135, 1, -128)
			RInput.Size = UDim2.new(0, 20, 0, 20)
			RInput.BackgroundColor3 = Color3.new(0.0549,0.0549,0.0549)
			RInput.BorderColor3 = Color3.new(0.1098,0.1098,0.1098)
			RInput.Text = tostring(math.floor(default.R * 255))
			RInput.TextColor3 = Color3.new(1, 1, 1)
			RInput.FontFace = Library.UIFont
			RInput.TextSize = Library.FontSize
			RInput.ClearTextOnFocus = false
			RInput.PlaceholderText = "R"
			RInput.ZIndex = 1220
			--
			GInput.Name = "GInput"
			GInput.Position = UDim2.new(0, 135, 1, -103)
			GInput.Size = UDim2.new(0, 20, 0, 20)
			GInput.BackgroundColor3 = Color3.new(0.0549,0.0549,0.0549)
			GInput.BorderColor3 = Color3.new(0.1098,0.1098,0.1098)
			GInput.Text = tostring(math.floor(default.G * 255))
			GInput.TextColor3 = Color3.new(1, 1, 1)
			GInput.TextSize = Library.FontSize
			GInput.FontFace = Library.UIFont
			GInput.ClearTextOnFocus = false
			GInput.PlaceholderText = "G"
			GInput.ZIndex = 1220
			--
			BInput.Name = "BInput"
			BInput.Position = UDim2.new(0, 135, 1, -78)
			BInput.Size = UDim2.new(0, 20, 0, 20)
			BInput.BackgroundColor3 = Color3.new(0.0549,0.0549,0.0549)
			BInput.BorderColor3 = Color3.new(0.1098,0.1098,0.1098)
			BInput.Text = tostring(math.floor(default.B * 255))
			BInput.TextColor3 = Color3.new(1, 1, 1)
			BInput.TextSize = Library.FontSize
			BInput.FontFace = Library.UIFont
			...
			local function set(color, a, nopos, setcolor)
			    ...
			    if hsv ~= oldcolor or alpha ~= oldalpha then
			        ...
			        RInput.Text = tostring(math.floor(hsv.R * 255))
			        GInput.Text = tostring(math.floor(hsv.G * 255))
			        BInput.Text = tostring(math.floor(hsv.B * 255))
			...
			local function UpdateColorInput()
			...
			-- honestly i can't add synchronization for Hue and Sat on textbox
			Library:Connection(RInput.FocusLost, UpdateColorInput)
			Library:Connection(GInput.FocusLost, UpdateColorInput)
			Library:Connection(BInput.FocusLost, UpdateColorInput)
	...
	do
		...
		function Library:Window(Options)
			...
			version.Text = "<font color=\"#4e4e4e\">v</font>4"
		...
		function Sections:Slider(Options)
			...
			Value.Size = Slider.Name and UDim2.new(1,-30,0,12) or UDim2.new(1,0,1,0)
			Value.BackgroundColor3 = Color3.new(1,1,1)
			Value.BackgroundTransparency = 1
			Value.Text = ""
					...
					if Dropdown.Max then
						if table.find(chosen, option) then
							...
							if #chosen == Dropdown.Max then
								Dropdown.OptionInsts[chosen[1]].text.TextColor3 = Color3.fromRGB(255,255,255)
...
function MergeTables(tbl1, tbl2)
    local merged = ShallowClone(tbl1)
...
function Signal:AddListener(callback)
    table.insert(self.listeners, callback)
end
function Signal:RemoveListener(callback)
...
do
    ...
    function Draw:Line(Properties)
        local Example = Drawing.new("Line")
        Example.Visible = Properties.Visible
        Example.Thickness = Properties.Thickness
        Example.From = Vector2.new(Properties.StartX, Properties.StartY)
        Example.To = Vector2.new(Properties.EndX, Properties.EndY)
        Example.Color = RGB(Properties.Color[1], Properties.Color[2], Properties.Color[3])
        Example.Transparency = Properties.Color[4] / 255
        table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
            table.insert(self.Objects, Example)
        end
        return Example
    end
    
    function Draw:Image(visible, imagedata, pos_x, pos_y, width, height, transparency)
		local Example = Drawing.new("Image")
		Example.Visible = visible
		Example.Position = Vector2.new(pos_x, pos_y)
		Example.Size = Vector2.new(width, height)
		Example.Transparency = transparency
		Example.Data = imagedata or placeholderImage
		table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
            table.insert(self.Objects, Example)
        end
    ...
    function Draw:OutlineRect(Properties)
        local Example = Drawing.new("Square")
        Example.Visible = Properties.Visible
        Example.Size = Vector2.new(Properties.Width, Properties.Height)
        Example.Position = Vector2.new(Properties.PositionX, Properties.PositionY)
        Example.Color = RGB(Properties.Color[1], Properties.Color[2], Properties.Color[3])
        Example.Transparency = Properties.Color[4] / 255
        table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
    ...
    function Draw:FilledRect(Properties)
        local Example = Drawing.new("Square")
        Example.Visible = Properties.Visible
        Example.Size = Vector2.new(Properties.Width, Properties.Height)
        Example.Position = Vector2.new(Properties.PositionX, Properties.PositionY)
    ...
    function Draw:OutlineCircle(Properties)
        local Example = Drawing.new("Circle")
        Example.Visible = Properties.Visible
        Example.Radius = Properties.Radius
        Example.Position = Vector2.new(Properties.PositionX, Properties.PositionY)
        Example.Color = RGB(Properties.Color[1], Properties.Color[2], Properties.Color[3])
        Example.Transparency = Properties.Color[4]
        table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
            table.insert(self.Objects, Example)
        end
    ...
    function Draw:FilledCircle(Properties)
        local Example = Drawing.new("Circle")
        Example.Visible = Properties.Visible
        Example.Radius = Properties.Radius
        Example.Position = Vector2.new(Properties.PositionX, Properties.PositionY)
    ...
    function Draw:Triangle(Properties)
        local Example = Drawing.new("Triangle")
        Example.Visible = Properties.Visible
        Example.Color = RGB(Properties.Color[1], Properties.Color[2], Properties.Color[3])
        Example.Transparency = Properties.Color[4] or 1
        Example.Thickness = 2.1
        if Properties.PA and Properties.PB and Properties.PC then
	        Example.PointA = Vector2.new(Properties.PA[1], Properties.PA[2])
	        Example.PointB = Vector2.new(Properties.PB[1], Properties.PB[2])
	        Example.PointC = Vector2.new(Properties.PC[1], Properties.PC[2])
		end
		Example.Filled = Properties.Filled
        table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
            table.insert(self.Objects, Example)
        end
    ...
    function Draw:Text(Properties)
        local Example = Drawing.new("Text")
		Example.Text = Properties.Text
		Example.Visible = Properties.Visible
		Example.Position = Vector2.new(Properties.PositionX, Properties.PositionY)
		Example.Size = Properties.Size
		Example.Center = Properties.Centered
		Example.Color = RGB(Properties.Color[1], Properties.Color[2], Properties.Color[3])
		Example.Transparency = Properties.Color[4] / 255
		Example.Outline = false
		Example.Font = Properties.Font
		table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
            table.insert(self.Objects, Example)
        end
    ...
    function Draw:OutlineText(Properties)
        local Example = Drawing.new("Text")
		Example.Text = Properties.Text
		Example.Visible = Properties.Visible
		Example.Position = Vector2.new(Properties.PositionX, Properties.PositionY)
		...
		Example.OutlineColor = RGB(Properties.Color2[1], Properties.Color2[2], Properties.Color2[3])
		Example.Font = Properties.Font
		table.insert(self.Objects, Example)
        if not table.find(self.Objects, Example) then
            table.insert(self.Objects, Example)
