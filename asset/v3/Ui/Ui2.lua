...
local Data = {
    ...
    faces = {{
        ...
        weight = 400,
        style = "normal",
        assetId = getcustomasset("mc_font.ttf")  -- Reference the downloaded .ttf file
    }}
}

-- Save the font data as a .font file
writefile("menu_font.font", game:GetService("HttpService"):JSONEncode(Data))

-- Load the custom font from the .font file
getgenv().menu_font = Font.new(getcustomasset("menu_font.font"), Enum.FontWeight.Light)

library.theme = {
    fontsize = 15,
    titlesize = 18,
    font = menu_font  -- You can replace this with your custom font if desired
    background = "rbxassetid://",  -- Update with your background asset if needed
    tilesize = 90,
    cursor = true,
    cursorimg = "https://t0.rbxcdn.com/42f66da98c40252ee151326a82aab51f",
    backgroundcolor = Color3.fromRGB(10, 10, 10),  -- Very dark background
    tabstextcolor = Color3.fromRGB(240, 240, 240),  -- Light text for readability
    bordercolor = Color3.fromRGB(40, 40, 40),  -- Darker borders
    accentcolor = Color3.fromRGB(0, 170, 255),  -- Bright cyan accent color for contrast
    accentcolor2 = Color3.fromRGB(0, 0, 255),  -- Another accent color (blue)
    outlinecolor = Color3.fromRGB(30, 30, 30),  -- Slightly lighter outline to match the dark theme
    outlinecolor2 = Color3.fromRGB(0, 0, 0),  -- Dark outline to maintain the theme
    sectorcolor = Color3.fromRGB(20, 20, 20),  -- Darker sector background for the UI
    toptextcolor = Color3.fromRGB(255, 255, 255),  -- Light text for the top area to contrast with dark background
    topheight = 48,
    topcolor = Color3.fromRGB(15, 15, 15),  -- Dark color for the top bar
    topcolor2 = Color3.fromRGB(25, 25, 25),  -- Slightly lighter top bar accent color
    buttoncolor = Color3.fromRGB(49, 49, 49),  -- Dark button background
    buttoncolor2 = Color3.fromRGB(39, 39, 39),  -- Slightly lighter button hover state
    itemscolor = Color3.fromRGB(180, 180, 180),  -- Light gray items for readability
    itemscolor2 = Color3.fromRGB(200, 200, 200),  -- Slightly lighter item color for hover or selected state
}
